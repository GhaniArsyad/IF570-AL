package id.ac.umn.week05_ghaniarsyad_37850;
...
public class CustomView extends View {
    ...
    protected void onDraw(Canvas canvas){
        ...
        if(!clear){
            //menggambar Bentuk antara(Rect, Oval, Line)
    ...
    public boolean onTouchEvent(MotionEvent event){
        ...
        switch(event.getAction()){
            case MotionEvent.ACTION_DOWN: mulaiSentuh(x,y); break;
            case MotionEvent.ACTION_MOVE: geser(x,y); break;
            case MotionEvent.ACTION_UP: lepas(); break;
            default:
        }
        return true;
    }
